...
class Cancha extends StatefulWidget {
  const Cancha({super.key});

  @override
  State<Cancha> createState() => _CanchaState();
}

class _CanchaState extends State<Cancha> {
  int _currentIndex = 0;

  final List<String> _routes = ['/second', '/third', '/favorites', '/profile'];
