...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Obtiene el estado actual del tema desde el proveedor ThemeProvider.
    final themeProvider = Provider.of<ThemeProvider>(context);

    // Define el tema claro de la aplicación.
    final lightTheme = ThemeData(
      brightness: Brightness.light, // Configuración de tema claro.
      primarySwatch: Colors.blue, // Color primario predeterminado.
      scaffoldBackgroundColor: Colors.white, // Fondo blanco para las pantallas.
